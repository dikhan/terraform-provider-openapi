...
func (o *SpecV2Resource) isOptionalComputedWithDefault(propertyName string, property spec.Schema) (bool, error) {
	if !o.isComputed(property) && property.Default != nil {
...
// isComputed return bool if the property is computed, meaning the value is expected to be generated by the API
func (o *SpecV2Resource) isComputed(property spec.Schema) bool {
